...
class VeiculosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create veiculo" do
    assert_difference('Veiculo.count') do
      post veiculos_url, params: { veiculo: { ano: @veiculo.ano, descricao: @veiculo.descricao, marca: @veiculo.marca, veiculo: @veiculo.veiculo, vendido: @veiculo.vendido } }, as: :json
    end
  ...
  test "should update veiculo" do
    patch veiculo_url(@veiculo), params: { veiculo: { ano: @veiculo.ano, descricao: @veiculo.descricao, marca: @veiculo.marca, veiculo: @veiculo.veiculo, vendido: @veiculo.vendido } }, as: :json
    assert_response 200
  end
